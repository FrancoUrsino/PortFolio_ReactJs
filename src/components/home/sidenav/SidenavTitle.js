...
const SidenavTitle = ({title,subTitle}) => {
  return (
    <h1 className="font-titleFont text-3xl font-semibold text-zinc-100 tracking-wide relative pb-5 mt-10 border-b-[1px] border-b-zinc-500">
      <span className="text-designColor pb-3">{title}</span>{subTitle}
